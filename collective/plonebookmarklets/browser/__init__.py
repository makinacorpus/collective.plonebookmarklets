...
class BookmarkletsView(BrowserView):
    ...
    def __init__(self, context, request):
        ...
        pp = self.context.portal_url.portal_properties
        self.props = pp.bookmarklets_properties
    ...
    def getSiteUrl(self, site):
        ...
        return site.replace('URL', url).replace('ENCODED_TITLE', 
                            encodedTitle).replace('DESCR', pageDescription)
